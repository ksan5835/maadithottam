...
<?php if(!empty($images)) { ?>
    ...
    <div class="<?php echo $this->slug; ?>-images-wrap" dir="ltr">
    	...
    	<?php if( $video_url ) { ?>
    	    <a href="javascript: void(0);" class="jck-wt-play" data-jck-wt-tooltip="<?php _e('Play Video', 'jck-wt'); ?>"><i class="jck-wt-icon jck-wt-icon-play"></i></a>
    	<?php } ?>
    ...
    <?php if( $video_url ) { ?>
        ...
        <div id="jck-wt-video-template" style="display: none;">

            <div class="jck-wt-video-wrapper">
                <div class="jck-wt-responsive-video">
